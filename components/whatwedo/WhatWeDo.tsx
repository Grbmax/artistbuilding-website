...
const WhatWeDo = () => {
  return (
    <section className='min-h-screen bg-black text-white sm:p-1 md:p-0'>
      <div className='grid h-full w-max items-center md:ml-10 md:grid-cols-1'>
        <div className='grid h-full w-full border-l-2 border-[#A67FB9] md:col-span-1 md:grid-cols-3 md:py-0 md:pl-5'>

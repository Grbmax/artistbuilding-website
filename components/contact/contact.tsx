...
const Contact = () => {
  ...
  return (
    ...
    >
      <div className='flex w-full justify-between gap-14 px-32'>
        <div className='flex w-1/3 flex-col gap-10'>
          <Heading heading='CONTACT US' font='sherika' className='text-3xl' />
          <div>
            <div className='flex items-center gap-3'>
              <Mail size={18} />
              <h2 className='text-xl'>artistbuildingstudio@gmail.com</h2>
            </div>
            <div className='flex items-center gap-3'>
              <Phone size={18} />
              <h2 className='text-xl'>+91-6232086836</h2>
            </div>
          </div>
          <div className='flex items-center gap-3'>
            <h2 className='h-full text-xl'>
        ...
        <form
          className='flex w-1/2 flex-col justify-evenly gap-5'
